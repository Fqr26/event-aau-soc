          ...
          <div className="text-white relative px-4 py-10 bg-indigo-400 shadow-lg sm:rounded-3xl sm:p-20">
            <div className="text-center pb-6">
              ...
              <p className="text-gray-300 py-2">
                Ready to take your marketing skills and networking to the next level? Get in
                touch with us today to attend our event your business goals and how we
            ...
            <div className="flex-row flex items-center">
              ...
              <span className="text-white ml-2">fikirseme29@gmail.com</span>
            </div>

            <div className="flex-row flex items-center">
              <FaPhoneVolume className="text-[50px] ml-4 p-2 text-white rounded-full cursor-pointer hover:scale-110 transition-all" />
              <span className="text-white ml-2">+251903769440</span>
            </div>

            <div className="items-center ml-32 py-2">
              <a href="https://www.github.com/Fqr26/" target="_blank">
