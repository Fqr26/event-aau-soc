...
function Approach() {
  const approachList = [
    {
      id: 1,
      title: "Invited local marketing professionals and entrepreneurs",
      description:
    ...
    {
      id: 2,
      title: "Marketing Trends Seminar, Exhibition & Networking event",
      description:
    ...
    {
      id: 3,
      title: "platform to showcase creative marketing projects",
      description:
