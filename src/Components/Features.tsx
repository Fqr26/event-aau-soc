            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white p-8 shadow-md rounded-md">
                ...
                <p className="text-gray-600">
                  Meet in person the local marketing professionals and entrepreneurs that have 
                  extensive experience in delivering successful campaigns across various industries.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/3  px-4 mb-8">
              <div className="bg-white p-8 h-[270px] shadow-md rounded-md">
                ...
                <p className="text-gray-600">
                   Enrich academic learning, inspire innovation, 
                   and strengthen the university’s connection to the marketing industry.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap ml-60 items-center">
            ...
            <div className="w-full md:w-1/3 px-4  mb-8">
              <div className="bg-white p-8 shadow-md rounded-md">
                ...
                <p className="text-gray-600">
                 Feature a seminar with expert talks, a panel discussion for deeper engagement, 
                 an exhibition showcasing innovative marketing ideas, 
